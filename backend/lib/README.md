...
We know we should render markdown serverside becuase client side
markdown rendering is difficult to implemement and provides inconsistent results.

our `render_items.py` will render our json with the markdown into html.
...
It would probably be better to render to collect markdown files with front
matter and turn those into json objects.
